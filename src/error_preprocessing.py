...
def get_event_list(main_table):
    ...
    event_list.to_csv('../errors/submission_list.csv', index=False)
...
def get_error_list(main_table):
    ...
    error_list.to_csv('../errors/submission_error_list.csv', index=False)
...
if __name__ == '__main__':
    ...
    df_error_ID = pd.read_csv('../errors/S19errors.csv')
