...
class DataProcess():
    def __init__(self, data_folder='../data', file_name='MainTable.csv'):
        print("Process Dataset %s" % os.path.join(data_folder,file_name))
        self.data_folder = data_folder
        self.file_name = file_name


    def pro_skill_graph(self):
        df = pd.read_csv(os.path.join(self.data_folder, self.file_name))
        df_question_concept = pd.read_csv(os.path.join(self.data_folder, "prompt_concept.csv"))
        df_concept = pd.read_csv(os.path.join(self.data_folder, "concepts.csv"))
        ...
        df_question_concept.to_csv(os.path.join(self.data_folder,'combined_concepts.csv'), index=False)
        # save pro-id-dict, skill-id-dict
        self.save_dict(pro_id_dict_original, os.path.join(self.data_folder, 'pro_id_dict.txt'))
        self.save_dict(pro_id_dict, os.path.join(self.data_folder, 'id_pro_dict.txt'))
    ...
    def extract_pro_pro_sim(self,pro_skill_csr,pro_num):
        ...
        sparse.save_npz(os.path.join(self.data_folder, 'pro_pro_sparse.npz'), pro_pro_sparse)
    ...
    def extract_skill_skill_sim(self,pro_skill_csc,skill_num):
        ...
        sparse.save_npz(os.path.join(self.data_folder, 'skill_skill_sparse.npz'), skill_skill_sparse)
...
if __name__ == '__main__':
    ...
    pro_skill_coo = sparse.load_npz("../data/pro_skill_sparse.npz")
